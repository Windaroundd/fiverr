...
const buttonBanner =
  "ml-2 bg-transparent hover:bg-white text-white-700 font-semibold hover:text-black  px-2 border border-white hover:border-transparent ";
      ...
      >
        <SwiperSlide>
          <LazyLoadImage
            ...
            effect="blur"
            src="http://demo5.cybersoft.edu.vn/img/1.png"
          />
          {/* <img
        ...
        <LazyLoadImage
            className="banner-img"
            effect="blur"
            src="http://demo5.cybersoft.edu.vn/img/2.png"
          />
        ...
        <LazyLoadImage
            className="banner-img"
            effect="blur"
            src="http://demo5.cybersoft.edu.vn/img/3.png"
          />
        </SwiperSlide>
        <SwiperSlide>
        <LazyLoadImage
            className="banner-img"
            effect="blur"
            src="http://demo5.cybersoft.edu.vn/img/4.png"
          />
        </SwiperSlide>
        <SwiperSlide>
        <LazyLoadImage
            className="banner-img"
            effect="blur"
            src="http://demo5.cybersoft.edu.vn/img/5.png"
          />
        </SwiperSlide>
      </Swiper>
          ...
          <div className="content ">
            <div className="searchLeft">
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-r-lg"
                >
                  Search
                </button>
                {/* </NavLink> */}
