...
export default function Banner() {
  return (
    <div>
      ...
      >
        <SwiperSlide>
          <img src="http://demo5.cybersoft.edu.vn/img/1.png" alt="" />
        </SwiperSlide>
        <SwiperSlide>
            ...
            <div className="searchLeft">
              ...
              <div className="flex popular">
                ...
                <div
                  ...
                  className="ml-2 bg-transparent hover:bg-white text-white-700 font-semibold hover:text-black py-1 px-2 border border-white hover:border-transparent "
                >
                  Website Design
                </div>
                <div
